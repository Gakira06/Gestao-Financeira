  ...
  return (
    <div className="print:hidden rounded-2xl border border-stone-200 bg-white/75 p-4 shadow-sm backdrop-blur-xl dark:border-stone-800 dark:bg-stone-900/70">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="grid min-w-55 flex-1 grid-cols-2 gap-2">
        ...
        <label className="flex min-w-50 flex-1 items-center gap-2 rounded-2xl border border-stone-200 bg-stone-50 px-3 dark:border-stone-800 dark:bg-stone-950">
