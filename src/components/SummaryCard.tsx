...
export function SummaryCard() {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-card rounded-2xl shadow-md p-6 flex flex-col gap-2">
        <span className="text-text-light font-medium flex items-center gap-2">
          <ArrowUpRight className="text-primary" /> Receitas Totais
        </span>
      ...
      <div className="bg-card rounded-2xl shadow-md p-6 flex flex-col gap-2">
        <span className="text-text-light font-medium flex items-center gap-2">
          <ArrowDownRight className="text-danger" /> Despesas Totais
        </span>
      ...
      <div className="bg-card rounded-2xl shadow-md p-6 flex flex-col gap-2 border-2 border-primary">
        <span className="text-text-light font-medium flex items-center gap-2">
          <DollarSign className="text-primary" /> Saldo Atual
        </span>
